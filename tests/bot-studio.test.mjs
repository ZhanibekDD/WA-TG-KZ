...
test("Bot Studio exposes the BotFather-class foundation", () => {
  for (const text of ["Создайте чат-бота", "API token", "Webhook", "Mini App", "Разрешения", "@QazynaBot"]) {
    assert.ok(page.includes(text));
  }
  assert.match(page, /qz_demo_/);
